...
const content: { [key: string]: ContentPageData } = {
  privacy: {
    ...
    sections: [{
      title: "",
      content: [
        { subtitle: "", text: "A sua privacidade é importante para nós. É política do Woman GO Safe respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Woman GO Safe, e outros sites que possuímos e operamos." },
  ...
  terms: {
    ...
    sections: [{
      title: "",
      content: [
        { subtitle: "", text: "Ao acessar ao site Woman GO Safe, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis." },
        { subtitle: "", text: "É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site Woman GO Safe , apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não uma transferência de título." },
        { subtitle: "", text: "Em nenhum caso o Woman GO Safe ou seus fornecedores serão responsáveis ​​por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os materiais em Woman GO Safe." }
      ]
    }]
  },
  contact: {
      ...
      <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-center text-sm text-gray-500">
            © {new Date().getFullYear()} Woman GO Safe. Feito por mulheres, para mulheres.
          </p>
