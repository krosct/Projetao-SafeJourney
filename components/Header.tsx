...
export const Header: React.FC<HeaderProps> = ({ onNavigate, activePage, currentUser, onLogout }) => {
  ...
  // Clique no avatar: agencia -> agencyDashboard ; usuária -> profile ; sem user -> login
        ...
        <div className="flex items-center justify-between h-20">
              ...
              {currentUser ? (
                <div className="flex items-center gap-4">
                  <div
                    ...
                    title={currentUser.email === 'agencia@app.com.br' ? 'Ir para o Painel da Agência' : 'Ver meu perfil'}
                    role="button"
                  ...
                  >
                    <img
                      ...
                      onError={(e) => { (e.target as HTMLImageElement).src = 'https://i.pravatar.cc/150?u=placeholder'; }}
                    />
                  ...
                  <button
                    onClick={onLogout}
                    className="px-5 py-2 bg-rose-600 text-white font-semibold rounded-md shadow-md hover:bg-rose-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-300"
                  >
                    Sair
                  </button>
                </div>
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              type="button"
              className="bg-white inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-300"
              ...
              {currentUser ? (
                <div className="pt-2 pb-1 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full text-center block px-3 py-2 rounded-md text-base font-medium bg-rose-600 text-white hover:bg-rose-700"
                  >
                    Sair
                  </button>
                </div>
                ...
                <button
                  ...
                  className="w-full text-center block px-3 py-2 rounded-md text-base font-medium bg-rose-400 text-white hover:bg-rose-500"
                >
                  Entrar
                </button>
              )}
